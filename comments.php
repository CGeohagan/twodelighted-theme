...
<div id="comments">
    ...
    if ( post_password_required() ) : ?>
        <p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'twodelighted-theme' ); ?></p>
    </div><!-- #comments -->
    <?php return;
    endif;
    ?>
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <ol class="commentlist">
            <?php
                /* See TwoDelighted_Theme_comment() in inc/functions/comments.php for more.  */
                wp_list_comments( array( 'callback' => 'TwoDelighted_Theme_comment' ) );
            ?>
        </ol>

        <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
        <nav id="comment-nav-below">
            <h1 class="assistive-text"><?php _e( 'Comment navigation', 'twodelighted-theme' ); ?></h1>
            <div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'twodelighted-theme' ) ); ?></div>
            <div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'twodelighted-theme' ) ); ?></div>
        </nav>
    ...
    ?>
        <p class="nocomments"><?php _e( 'Comments are closed.', 'twodelighted-theme' ); ?></p>
    <?php endif; ?>
